...
HTTP::Tiny::CLIBackend - Use network CLI client (curl/wget) with HTTP::Tiny interface

=head1 VERSION

This document describes version 0.01 of HTTP::Tiny::CLIBackend (from Perl distribution HTTP-Tiny-CLIBackend), released on 2014-11-18.
...
Please visit the project's homepage at L<https://metacpan.org/release/HTTP-Tiny-CLIBackend>.

=head1 SOURCE

Source repository is at L<https://github.com/perlancar/perl-HTTP-Tiny-CLIBackend>.

=head1 BUGS

Please report any bugs or feature requests on the bugtracker website L<https://rt.cpan.org/Public/Dist/Display.html?Name=HTTP-Tiny-CLIBackend>
